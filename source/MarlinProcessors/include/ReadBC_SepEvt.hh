...
class ReadBC_SepEvt : public marlin::Processor {
  
 public:
  
  virtual Processor*  newProcessor() { return new ReadBC_SepEvt ; }
...
private://to shut the warnings up
  ReadBC_SepEvt(const ReadBC_SepEvt&);
  ReadBC_SepEvt& operator=(const ReadBC_SepEvt&);
