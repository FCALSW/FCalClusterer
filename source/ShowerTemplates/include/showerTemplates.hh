...
{
private:
	double _eFactor, _p0a, _p1a, _p0b, _p1b;
	void InitParameters(double deposit);
public:
	ProfileTester(double eFactor=56.72, double p0a=0.737, double p1a=1.75, double p0b=.02209, double p1b=1.8e6, double loEdge=0.5, double hiEdge=39.5);
	~ProfileTester();

	void Calibrate(double eFactor, double p0a=0.737, double p1a=1.75, double p0b=.02209, double p1b=1.8e6);
